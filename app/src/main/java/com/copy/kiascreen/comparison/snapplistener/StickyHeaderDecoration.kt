...
import com.copy.kiascreen.comparison.adapter.StickyHeader
import com.copy.kiascreen.dpToPix
import java.util.*
...
class StickyHeaderDecoration : RecyclerView.ItemDecoration() {
    ...
    fun updateStickyHeaders() {
        ...
        stickyHeadersMap.forEach { entry: Map.Entry<Any, RecyclerView.ViewHolder?> ->
            ...
            try {
                ...
                Log.d("stickyTest", e.message.toString())
            }
        }
    }
    ...
    companion object {
        ...
        private val STICKY_THRESHOLD = 2f.dpToPix()
